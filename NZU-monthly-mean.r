...
str(data)
'data.frame':	2146 obs. of  5 variables:
...
str(weeklypriceallDates)
 Date[1:811], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2025-10-13
  Data: num [1:811] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:811], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	811 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2025-09-25
  ...
  Index:  Date[1:5671], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
idHoliday <- c(FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 
...
#str(idHoliday)
#List of 2
# $ value  : logi [1:4051] FALSE FALSE FALSE FALSE FALSE FALSE ...
# $ visible: logi TRUE


spotpricefilleddataframe$Holiday <- idHoliday
