...
str(data)
'data.frame':	1919 obs. of  5 variables:
...
str(weeklyprice) 
'data.frame':	656 obs. of  2 variables:
...
str(weeklypriceallDates)
 Date[1:751], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  ...
  Index:  Date[1:751], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
str(spotprice) 
'data.frame':	1919 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
'data.frame':	5251 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-08-30
  ...
  Index:  Date[1:5251], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
