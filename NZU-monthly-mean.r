...
# examine dataframe
str(data)
'data.frame':	1810 obs. of  5 variables:
...
# look at the last row => its the column headers
data[nrow(data),]
       V1    V2        V3    V4   V5
1810 date price reference month week
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1809] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklyprice)
'data.frame':	633 obs. of  3 variables:
...
str(weeklypriceallDates)
 Date[1:728], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  Data: num [1:728] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:728], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
‘zoo’ series from 2010-05-10 to 2024-02-26
  Data: num [1:728] 17.8 17.5 17.5 17.2 17 ...
  Index:  Date[1:728], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
str(spotprice) 
'data.frame':	1809 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
'data.frame':	5090 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-04-05
  Data: num [1:5090] 17.8 NA NA NA NA ...
  Index:  Date[1:5090], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
str(spotpricefilled) 
‘zoo’ series from 2010-05-14 to 2024-04-19
  Data: num [1:5090] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5090], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
str(spotpricefilleddataframe)
'data.frame':	3636 obs. of  3 variables:
...
str(spotrollmean31) 
'data.frame':	3636 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-17" ...
...
str(weekts) 
Time-Series [1:728] from 2010 to 2024: 17.8 17.5 17.5 17.2 17 ... 
 weeklypricefilled
