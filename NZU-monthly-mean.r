...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:2136] 2010-W19-5 2010-W20-5 2010-W21-6 2010-W23-5 ...
  ..- attr(*, "week_start")= int 1 
...
tail(weeklyprice)
week price       date
705 2025-W40 56.97 2025-09-29
706 2025-W41 56.35 2025-10-06
707 2025-W42 55.98 2025-10-13
708 2025-W43 55.40 2025-10-20
709 2025-W44 53.11 2025-10-27
710 2025-W45 48.51 2025-11-03
...
str(weeklypriceallDates)
 Date[1:809], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2025-10-13
  Data: num [1:809] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:809], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	809 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2025-09-25
  ...
  Index:  Date[1:5657], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
source (file="idHoliday.r", local=FALSE, verbose=FALSE, print.eval=FALSE, chdir=TRUE)
str(idHoliday)
 logi [1:4026] FALSE FALSE FALSE FALSE FALSE FALSE ...
...
'data.frame':	3872 obs. of  3 variables:
...
str(spotrollmean31) 
'data.frame':	3872 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-17" ...
