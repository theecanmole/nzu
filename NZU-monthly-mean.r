...
str(data)
'data.frame':	1885 obs. of  6 variables:
...
str(weeklypriceallDates)
 Date[1:744], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  ...
  Index:  Date[1:744], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
str(spotprice) 
'data.frame':	1885 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
‘zoo’ series from 2010-05-14 to 2024-07-12
  ...
  Index:  Date[1:5202], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
