...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1994] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklyprice) 
'data.frame':	672 obs. of  2 variables:
...
str(weeklyprice)
'data.frame':	672 obs. of  3 variables:
...
str(weeklypriceallDates)
 Date[1:771], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	771 obs. of  3 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  Data: num [1:771] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:771], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
‘zoo’ series from 2010-05-10 to 2024-08-26
  Data: num [1:771] 17.8 17.5 17.5 17.2 17 ...
  Index:  Date[1:771], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	771 obs. of  2 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
str(spotprice) 
'data.frame':	1994 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
‘zoo’ series from 2010-05-14 to 2024-08-30
  ...
  Index:  Date[1:5391], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
