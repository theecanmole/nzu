...
str(data)
'data.frame':	2028 obs. of  5 variables:
 ...
 $ week     :Class 'aweek'  atomic [1:2028] 2010-W19-5 2010-W20-5 2010-W21-6 2010-W23-5 ...
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:2028] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
'data.frame':	679 obs. of  2 variables:
 $ week :Class 'aweek'  atomic [1:679] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  .. ..- attr(*, "week_start")= int 1
 $ price: num  17.8 17.5 17.5 17 17.8 ...
...
str(weeklypriceallDates)
 Date[1:778], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	778 obs. of  3 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  Data: num [1:778] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:778], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
‘zoo’ series from 2010-05-10 to 2024-08-26
  Data: num [1:778] 17.8 17.5 17.5 17.2 17 ...
  Index:  Date[1:778], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
str(spotprice) 
'data.frame':	2028 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
'data.frame':	5440 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-04-05
  Data: num [1:5440] 17.8 NA NA NA NA ...
  Index:  Date[1:5440], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
‘zoo’ series from 2010-05-14 to 2024-08-30
  Data: num [1:5440] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5440], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
tail(spotpricefilleddataframe)
           date price       day
5433 2025-03-28 58.75    Friday
5436 2025-03-31 57.00    Monday
5437 2025-04-01 57.00   Tuesday
5438 2025-04-02 56.48 Wednesday
5439 2025-04-03 55.00  Thursday
5440 2025-04-04 55.00    Friday

str(spotpricefilleddataframe)
'data.frame':	3886 obs. of  3 variables:
...
str(spot) 
'data.frame':	3886 obs. of  2 variables:
 $ date      : Date, format: "2010-05-14" "2010-05-17" ...
 $ price     : num  17.8 17.6 17.6 17.6 17.5 ...
nrow(spot)
3886
