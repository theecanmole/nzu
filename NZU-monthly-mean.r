...
data[nrow(data),]
       V1    V2        V3    V4   V5
1800 date price reference month week
tail(data,1)
       V1    V2        V3    V4   V5
1800 date price reference month week
...
'data.frame':	1800 obs. of  6 variables:
 ...
 $ week      :Class 'aweek'  atomic [1:1795] 2010-W19 2010-W20 2010-W21 2010-W23 ...
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1799] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklyprice)
'data.frame':	631 obs. of  3 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ...
 $ week :Class 'aweek'  atomic [1:631] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  .. ..- attr(*, "week_start")= int 1
...
'data.frame':	726 obs. of  3 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
‘zoo’ series from 2010-05-10 to 2024-02-26
  Data: num [1:726] 17.8 17.5 17.5 17.2 17 ...
  Index:  Date[1:726], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	726 obs. of  2 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
'data.frame':	5076 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-04-05
  Data: num [1:5076] 17.8 NA NA NA NA ...
...
str(spotpricefilled) 
‘zoo’ series from 2010-05-14 to 2024-04-05
  Data: num [1:5086] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5088], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
str(spotpricefilleddataframe)
'data.frame':	3626 obs. of  3 variables:
