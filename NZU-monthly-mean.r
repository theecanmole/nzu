...
# examine dataframe
str(data)
'data.frame':	1796 obs. of  5 variables:
...
data[nrow(data),]
       V1    V2        V3    V4   V5
1796 date price reference month week
tail(data,1)
       V1    V2        V3    V4   V5
1796 date price reference month week
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1795] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
'data.frame':	630 obs. of  3 variables:
 ...
 $ price: num  17.8 17.5 17.5 17 17.8 ...
 $ week :Class 'aweek'  atomic [1:630] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  .. ..- attr(*, "week_start")= int 1
...
'data.frame':	725 obs. of  3 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
str(spotprice) 
'data.frame':	1795 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
'data.frame':	5068 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2023-12-22
  Data: num [1:5068] 17.8 NA NA NA NA ...
  Index:  Date[1:5068], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
‘zoo’ series from 2010-05-14 to 2024-03-01
  Data: num [1:5068] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5068], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
str(spotpricefilleddataframe)
'data.frame':	3620 obs. of  3 variables:
...
str(spotrollmean31) 
'data.frame':	3620 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-17" ...
...
str(weekts) 
Time-Series [1:725] from 2010 to 2024: 17.8 17.5 17.5 17.2 17 ... 
