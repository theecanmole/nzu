...
# examine dataframe
str(data)
'data.frame':	1896 obs. of  5 variables:
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1895] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklypriceallDates)
 Date[1:746], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  ...
  Index:  Date[1:746], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
'data.frame':	5216 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-04-05
  Data: num [1:5216] 17.8 NA NA NA NA ...
  Index:  Date[1:5216], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
‘zoo’ series from 2010-05-14 to 2024-07-12
  Data: num [1:5216] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5216], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
str(spotpricefilleddataframe)
'data.frame':	3726 obs. of  3 variables:
...
str(spot) 
'data.frame':	3726 obs. of  2 variables:
 $ date      : Date, format: "2010-05-14" "2010-05-17" ...
 $ price     : num  17.8 17.6 17.6 17.6 17.5 ...
nrow(spot)
3726
