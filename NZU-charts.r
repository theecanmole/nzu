...
mtext(side=1,cex=1,line=-1.2,"Data: 'NZU-price-data-2010-2016' http://bit.ly/2fHbojr")
...
par(mar=c(2.7,2.7,1,1)+0.1)
plot(decimal,monthprice[["price"]],ylim=c(0,24),tck=0.01,axes=TRUE,ann=TRUE, las=1,col=2,lwd=1,type='l',lty=1)
points(decimal,monthprice[["price"]],pch = 20)
