...
str(data)
'data.frame':	1924 obs. of  5 variables:
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1924] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklypriceallDates)
 Date[1:752], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  Data: num [1:752] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:752], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
'data.frame':	5258 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-08-30
  ...
  Index:  Date[1:5258], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
