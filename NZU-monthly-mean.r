...
str(data)
'data.frame':	1953 obs. of  5 variables:
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1953] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklyprice) 
'data.frame':	663 obs. of  2 variables:
...
tail(weeklyprice)
        week   price
658 2024-W41 62.7060
659 2024-W42 62.9240
660 2024-W43 62.9200
661 2024-W44 63.0825
662 2024-W45 63.5720
663 2024-W46 63.7920 
...
str(weeklyprice)
'data.frame':	663 obs. of  3 variables:
...
str(weeklypriceallDates)
 Date[1:758], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	758 obs. of  3 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  Data: num [1:758] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:758], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
‘zoo’ series from 2010-05-10 to 2024-08-26
  Data: num [1:758] 17.8 17.5 17.5 17.2 17 ...
  Index:  Date[1:758], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	758 obs. of  2 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
str(spotprice) 
'data.frame':	1953 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
‘zoo’ series from 2010-05-14 to 2024-08-30
  ...
  Index:  Date[1:5300], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
5296 2024-11-11 63.80    Monday
5297 2024-11-12 63.76   Tuesday
5298 2024-11-13 63.75 Wednesday
5299 2024-11-14 63.87  Thursday
...
plot(mpzoo,tck=0.01,axes=TRUE,ann=TRUE, las=1,col="#ED1A3B",lwd=2,type='l',lty=1)
