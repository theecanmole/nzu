...
data[nrow(data),]
       V1    V2        V3    V4   V5
1843 date price reference month week
...
str(data)
'data.frame':	1842 obs. of  6 variables:
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1842] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklypriceallDates)
 Date[1:735], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	735 obs. of  3 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
‘zoo’ series from 2010-05-10 to 2024-02-26
  Data: num [1:735] 17.8 17.5 17.5 17.2 17 ...
  Index:  Date[1:735], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	735 obs. of  2 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
str(spotprice) 
'data.frame':	1842 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
'data.frame':	5139 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-04-05
  Data: num [1:5139] 17.8 NA NA NA NA ...
  Index:  Date[1:5139], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
‘zoo’ series from 2010-05-14 to 2024-04-19
  Data: num [1:5139] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5139], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
str(spot) 
'data.frame':	3671 obs. of  2 variables:
 $ date      : Date, format: "2010-05-14" "2010-05-17" ...
 $ price     : num  17.8 17.6 17.6 17.6 17.5 ...
nrow(spot)
3671
...
str(weekts) 
Time-Series [1:735] from 2010 to 2024: 17.8 17.5 17.5 17.2 17 ... 
 weeklypricefilled
