...
# examine dataframe
str(data)
'data.frame':	1915 obs. of  5 variables:
...
## weekly time series
str(data$week) 
Class 'aweek'  atomic [1:1914] 2010-W19 2010-W20 2010-W21 2010-W23 ...
  ..- attr(*, "week_start")= int 1 
head(data$week,2) 
<aweek start: Monday>
...
str(weeklyprice) 
'data.frame':	655 obs. of  2 variables:
...
str(weeklyprice)
'data.frame':	655 obs. of  3 variables:
...
str(weeklypriceallDates)
 Date[1:750], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
‘zoo’ series from 2010-05-10 to 2024-04-08
  Data: num [1:750] 17.8 17.5 17.5 NA 17 ...
  Index:  Date[1:750], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" 
...
‘zoo’ series from 2010-05-10 to 2024-08-26
  Data: num [1:750] 17.8 17.5 17.5 17.2 17 ...
  Index:  Date[1:750], format: "2010-05-10" "2010-05-17" "2010-05-24" "2010-05-31" ...
...
'data.frame':	750 obs. of  2 variables:
 $ date : Date, format: "2010-05-10" "2010-05-17" ...
...
str(spotprice) 
'data.frame':	1914 obs. of  2 variables:
 $ date : Date, format: "2010-05-14" "2010-05-21" ...
 $ price: num  17.8 17.5 17.5 17 17.8 ... 
...
'data.frame':	5244 obs. of  2 variables:
...
‘zoo’ series from 2010-05-14 to 2024-04-05
  Data: num [1:5244] 17.8 NA NA NA NA ...
  Index:  Date[1:5244], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" "2010-05-18" ...
...
‘zoo’ series from 2010-05-14 to 2024-08-30
  Data: num [1:5244] 17.8 17.7 17.7 17.6 17.6 ...
  Index:  Date[1:5244], format: "2010-05-14" "2010-05-15" "2010-05-16" "2010-05-17" ...
...
'data.frame':	3746 obs. of  3 variables:
...
str(spot) 
'data.frame':	3746 obs. of  2 variables:
 $ date      : Date, format: "2010-05-14" "2010-05-17" ...
 $ price     : num  17.8 17.6 17.6 17.6 17.5 ...
nrow(spot)
3746
